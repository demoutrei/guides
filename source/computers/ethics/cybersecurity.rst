:description: Cyber security is the practice of defending computers, servers, mobile devices, networks, and data from digital attacks, theft, or unauthorized access.
...
A :term:`zero-day exploit` is a :term:`cyber attack` that takes place before the security community and/or software developers become aware of and fix a :term:`security vulnerability`. It takes advantage of security flaws that enable unauthorized users to gain access to a computer system or to download sensitive user data. Until a zero-day exploit is discovered and a :term:`patch` is written to fix the underlying flaw, users of the software are vulnerable to attack.
...
.. grid:: 1
    ...
    .. grid-item-card:: Growing Reliance on Commercial Software with Known Vulnerabilities

        In computing, an :term:`exploit` is an attack on an information system that takes advantage of a particular system vulnerability. Often this attack is due to poor system design or implementation. Once the vulnerability is discovered, software develoeprs create and issue a "fix", or :term:`patch` to eliminate the problem. Users of the system or application are responsible for obtaining and installing the patch, which they can usually download from the web.
...
.. grid:: 1
    ...
    .. grid-item-card:: Advanced Persistent Threat
        ...
        1. Reconnaissance.
            The intruder begins by conducting :term:`reconnaissance` on the network to gain useful information about the target (security software installed, computing resources connected to the network, number of users).

        2. Incursion.
            The attacker next launches :term:`incursion` s to gain access to the network at a low level to avoid setting off any alarms or suspicion. Some forms of spear phishing may be employed in this phase. After gaining entrance, the attacker establishes a :term:`backdoor`, or a means of accessing a computer program that bypasses security mechanisms.

        3. Discovery.
            The intruder now begins a discovery process to gather valid user credentials (especially administrative ones) and move laterally across the network, installing more backdoors. These backdoors enable the attacker to install :term:`bogus` utilities for distributing malware that remains hidden in plain sight.
        ...
        Although APT attacks are difficult to identify, the theft of data can never be completely invisible. Detecting anomalies in :term:`outbound data` is perhaps the best way for an administrator to discover that the network has been the target of an APT attack.
...
.. grid:: 1
    ...
    .. grid-item-card:: Risk Assessment
        ...
        +-------------+-----------------+------------+------------------+------------+-----------------+----------+
        | Adverse     | Business        | Threat     | Vulnerability    | Estimated  | Risk = Threat x | Relative |
        | event       | objective       | (estimated | (likelihood of   | cost of a  | Vulnerability x | priority |
        |             | threatened      | frequency  | sucess of        | successful | Estimated       | to be    |
        |             |                 | of event)  | this threat) (%) | attack ($) | cost ($)        | fixed    |
        |             |                 | per year   |                  |            |                 |          |
        +=============+=================+============+==================+============+=================+==========+
        | Data breach | Provide a safe, | 18         | 3                | 5,000,000  | 2,700,000       | 1        |
        | of customer | secure website  |            |                  |            |                 |          |
        | account     | that consumers  |            |                  |            |                 |          |
        | data        | can trust       |            |                  |            |                 |          |
        +-------------+-----------------+------------+------------------+------------+-----------------+----------+
        | Dstributed  | 24/7 operation  | 3          | 25               | 500,000    | 375,000         | 2        |
        | DDoS        | of a retail     |            |                  |            |                 |          |
        | attack      | website         |            |                  |            |                 |          |
        +-------------+-----------------+------------+------------------+------------+-----------------+----------+
        | Email       | Rapid and       | 1,000      | 0.05             | 200,000    | 100,000         | 3        |
        | attachment  | reliable        |            |                  |            |                 |          |
        | with        | communications  |            |                  |            |                 |          |
        | harmful     | among           |            |                  |            |                 |          |
        | worm        | employees and   |            |                  |            |                 |          |
        |             | suppliers       |            |                  |            |                 |          |
        +-------------+-----------------+------------+------------------+------------+-----------------+----------+
        | Harmful     | Employees'      | 2,000      | 0.04             | 50,000     | 40,000          | 4        |
        | virus       | use of personal |            |                  |            |                 |          |
        |             | productivity    |            |                  |            |                 |          |
        |             | software        |            |                  |            |                 |          |
        +-------------+-----------------+------------+------------------+------------+-----------------+----------+
        | Invoice and | Reliable cash   | 1          | 10               | 200,000    | 20,000          | 5        |
        | payment     | flow            |            |                  |            |                 |          |
        | fraud       |                 |            |                  |            |                 |          |
        +-------------+-----------------+------------+------------------+------------+-----------------+----------+


    .. grid-item-card:: Disaster Recovery
        ...
        Files and databases can be protected by making a copy of all files and databases changed during the last few days or the last week, a technique called :term:`incremental backup`. This approach to backup uses an image log, which is a separate file that contains only changes to applications or data. Whenever an application is run, an :term:`image log` is created that contains all changes made to all files. If a problem occurs with a database, an old database with the last full backup of the data, along with the :term:`image log`, can be used to re-create the current database.
    ...
    .. grid-item-card:: Regulatory Standards Compliance
        ...
        +==============================+=====================================+====================================+
        | Bank Secrecy Act of 190      | Financial institutions              | Requires financial institutions in |
        | (Public Law 91-507)---       |                                     | the United States to assist U.S.   |
        | Amended several times,       |                                     | government agencies in detecting   |
        | including by provisions in   |                                     | and preventing money laundering    |
        | Title III of the USA PATRIOT |                                     |                                    |
        | Act (see 31 USC S. 5311-5330 |                                     |                                    |
        | and Title 31 Code of Federal |                                     |                                    |
        | Regulations Chapter X)       |                                     |                                    |
        +------------------------------+-------------------------------------+------------------------------------+
        | European Union---United      | Organizations that do business with | Provides companies on both         |
        | States Privacy Shield        | companies and/or individuals in the | sides of the Atlantic with a       |
        |                              | European Union                      | mechanism to comply with EU        |
        ...
        +------------------------------+-------------------------------------+------------------------------------+
        | Federal Information          | Every federal agency                | Requires each federal agency to    |
        | Security Management          |                                     | provide information security for   |
        | Act (44 U.S.C.               |                                     | the data and information systems   |
        | S. 3541, et seq.)            |                                     | that support the agency's          |
        |                              |                                     | operations and assets, including   |
        |                              |                                     | those provided or managed by       |
        |                              |                                     | another agency, contractor, or     |
        |                              |                                     | other source.                      |
        +------------------------------+-------------------------------------+------------------------------------+
        | Foreign Corrupt Practices    | Any person who is a citizen,        | Makes certain payments to foreign  |
        | Act (15 U.S.C. S. 78dd-1,    | national, or resident of the United | officials and other foreign        |
        | et seq.)                     | States and engages in foreign       | persons illegal and requires       |
        |                              | corrupt practices; also applies to  | companies to maintain accurate     |
        |                              | any act by U.S. businesses, foreign | records.                           |
        |                              | corporation's trading securities in |                                    |
        |                              | the United States, American         |                                    |
        |                              | nationals, U.S. citizens, and U.S.  |                                    |
        |                              | residents acting in furtherance of  |                                    |
        |                              | a foreign corrupt practice whether  |                                    |
        |                              | or not they are physicall present   |                                    |
        |                              | in the United States.               |                                    |
        +------------------------------+-------------------------------------+------------------------------------+
        | Gramm-Leach-Bliley Act       | Companies that offer financial      | Governs the collection,            |
        | (Public Law 106-102)         | products or services to             | disclosure, and protection of      |
        |                              | individuals, such as loans,         | consumers' nonpublic personal      |
        |                              | insurance, or financial and         | information or personally          |
        |                              | investment advice.                  | identifiable information.          |
        +------------------------------+-------------------------------------+------------------------------------+
        | Health Insurance Portability | Healthcare clearinghouses,          | Regulates the use and disclosure   |
        | and Accountability Act       | employer-sponsored health plans,    | of an individual's health          |
        | (Public Law 104-191)         | health insurers, and medical        | information                        |
        |                              | service providers                   |                                    |
        +------------------------------+-------------------------------------+------------------------------------+
        | Payment Card Industry        | All organizations that store,       | Provides a framework of            |
        | Data Security Standard (PCI  | process, and transmit cardholder    | specifications, tools,             |
        | DSS)                         | data, most notably for debit cards  | measurements, and support          |
        |                              | and credit cards.                   | resources to help organizations    |
        |                              |                                     | ensure the safe handling of        |
        |                              |                                     | cardholder information.            |
        +------------------------------+-------------------------------------+------------------------------------+
        | Sarbanes-Oxley Act (Public   | All public corporations             | Protects shareholders and the      |
        | Law 107-204 116 Stat. 745)   |                                     | general public from accounting     |
    ...
    .. grid-item-card:: Security Dashboard
        ...
        +---+----------------------------------------------------------------+------+--------+--------+
        | 6 | Percentage of employees and contractors who passed security    | >95% | 87%    | Red    |
        |   | exam                                                           |      |        |        |
        +---+----------------------------------------------------------------+------+--------+--------+
...
.. grid:: 1
    ...
    .. grid-item-card:: Authentication Methods
...
.. grid:: 1
    ...
    .. grid-item-card:: User Roles and Accounts
...
.. grid:: 1
    ...
    .. grid-item-card:: Security Education
        ...
        +-----------------------------------------------------------------------------------------------------------+
        | Do you use different, strong passwords for each of your accounts and applications---a minimum of 10       |
        | characters, with a mix of capital and lowercase letters, numbers, and special characters?                 |
        +-----------------------------------------------------------------------------------------------------------+
        | Are you familiar with and do you follow your organization's policies in regard to accessing corporate     |
        | websites and applications from your home or remote locations (for example, access via a VPN)?             |
        +-----------------------------------------------------------------------------------------------------------+
        | Have you set the encryption method to WPA2 and changed the default name and password on your              |
        | home wireless router?                                                                                     |
        +-----------------------------------------------------------------------------------------------------------+
        | When using a free, public wireless network, do you avoid checking your email or accessing websites        |
        ...
        +-----------------------------------------------------------------------------------------------------------+
        | Are you familiar with and do you follow your organization's policies regarding the storage of personal or |
        | confidential data on your device?                                                                         |
        +-----------------------------------------------------------------------------------------------------------+
        ...
        +-----------------------------------------------------------------------------------------------------------+
        | Have you reviewed and do you understand the privacy settings that control who can see or read what        |
        | you do on Facebook and other social media sites?                                                          |
        +-----------------------------------------------------------------------------------------------------------+
    ...
    .. grid-item-card:: Antivirus Software
...
.. grid:: 1
    ...
    .. grid-item-card:: Incident Notification
    ...
    .. grid-item-card:: Protection of Evidence and Activity Logs
    ...
    .. grid-item-card:: Incident Containment
    ...
    .. grid-item-card:: Incident Follow-Up
    ...
    .. grid-item-card:: Computer Forensics
        ...
        | Question                                                                                                      |
        +===============================================================================================================+
        | Has a risk assessment been performed to identify investments in time and resources that can protect the       |
        | organization from its most likely and most serious threats?                                                   |
        +---------------------------------------------------------------------------------------------------------------+
        | Have senior management and employees involved in implementing security measures been educated                 |
        | about the concept of reasonable assurance?                                                                    |
        +---------------------------------------------------------------------------------------------------------------+
        ...
        +---------------------------------------------------------------------------------------------------------------+
        | Is it a requirement to review at least quarterly the most critical Internet security threats and implement    |
        | safeguards against them?                                                                                      |
        +---------------------------------------------------------------------------------------------------------------+
        | Has it been verified that backup processes for critical software and databases work correctly?                |
        +---------------------------------------------------------------------------------------------------------------+
        | Has an intrusion detection system been implemented to catch intruders in the act---both in the network        |
        | and on critical computers on the network?                                                                     |
        +---------------------------------------------------------------------------------------------------------------+
...
.. glossary::
    ...
    Anonymous
      A decentralized, leaderless international collective of activists and computer hackers known as hacktivists.
    ...
    Customer Relationship Management
      A combination of strategies, practices, and software tools that a company uses to manage and improve all interactions with current, past, and potential customers.
    ...
    Cyberspionage
      Involved the deployment of malware that secretly steals data in the computer systems of organizations, such as government agencies, military contractors, political organizations, and manufacturing firms.

    Cyberterrorism
      The intimidation of government or civilian population by using information technology to disable critical national infrastructure to achieve political, religious, or ideological goals.
    ...
    Department of Defense
      An executive branch department of the federal government that coordinates and manages all agencies and functions of the U.S. Armed Forces.

    Distributed Denial-of-Service Attack
      A malicious hacker takes over computers via the Internet and causes the mto flood a target site with demands for data and other small tasks.
    ...
    Enterprise Resource Planning
      A software platform that organizations use to manage and integrate their core day-to-day business processes, such as finance, HR, manufacturing, supply chain, and procurement, into a single shared system.
    ...
    Federal Bureau of Investigation
      The principal federal law enforcement and domestic intelligence agency of the United States.
    ...
    Logic bomb
      A piece of malicious code secretly hidden inside a software system or network that stays dormant until a specific condition or trigger is met.

    Macro
      A single rule, pattern, or instruction that automatically expands into a larger sequence of commands or code.

    Macro virus
      A malicious program hidden inside software macros—automated sequences of commands used in office applications like Microsoft Word or Excel.
    ...
    Malware
      Short for **malicious software**; an umbrella term for any program or code intentionally designed to damage, disrupt, steal from, or gain unauthorized access to a computer, server, or network.
    ...
    TeslaTeam
      A Serbian-based black-hat computer hacker group first formed in 2010. Operating as a self-described "virtual army," the group is primarily known for conducting cyber attacks utilizing denial-of-service (DDoS) methods, website defacement, and other digital intrusion techniques.
    ...
    Wireless Protected Access 2
      Most commonly used security protocol for wireless networks.
